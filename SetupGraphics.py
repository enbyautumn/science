...
text2 = colored("To access the 24-hour forcast, press 2", 'blue')
text3 = colored("To access the 48-hour forcast, press 3", 'blue')
text4 = colored("To access the 72-hour forecast, press 4", 'blue')
print(text)
print(text2)
print(text3)
print(text4)
